	...
	<section>
      ...
      <article class="childart1">
        ...
        <div class="swiper-container swc2" id="swc" style="width: 1100px;">
          <div class="swiper-wrapper">
            <div class="swiper-slide"><img src="resources/images/storeimg/1.PNG" width="250px" height="300px">
              <div class="swiper-text" style="padding-left: 0px;">공예
                <div class="text_title">센티멘탈 감성이 짙게 묻은 굿즈</div>
                <div class="like_view"><span class="like_icon"><svg width="8px" height="8px" viewBox="0 0 16 16"
            ...
            <div class="swiper-slide"><img src="resources/images/storeimg/2.PNG" width="250px" height="300px">
              <div class="swiper-text" style="padding-left: 0px;">공예
                <div class="text_title">센티멘탈 감성이 짙게 묻은 굿즈</div>
                <div class="like_view"><span class="like_icon"><svg width="8px" height="8px" viewBox="0 0 16 16"
                      class="bi bi-heart-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="swiper-slide"><img src="resources/images/storeimg/3.PNG" width="250px" height="300px">
              <div class="swiper-text" style="padding-left: 0px;">공예
                <div class="text_title">센티멘탈 감성이 짙게 묻은 굿즈</div>
                <div class="like_view"><span class="like_icon"><svg width="8px" height="8px" viewBox="0 0 16 16"
                      class="bi bi-heart-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="swiper-slide"><img src="resources/images/storeimg/4.PNG" width="250px" height="300px">
              <div class="swiper-text" style="padding-left: 0px;">공예
                <div class="text_title">센티멘탈 감성이 짙게 묻은 굿즈</div>
                <div class="like_view"><span class="like_icon"><svg width="8px" height="8px" viewBox="0 0 16 16"
                      class="bi bi-heart-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="swiper-slide"><img src="resources/images/storeimg/5.PNG" width="250px" height="300px">
              <div class="swiper-text" style="padding-left: 0px;">공예
                <div class="text_title">센티멘탈 감성이 짙게 묻은 굿즈</div>
                <div class="like_view"><span class="like_icon"><svg width="8px" height="8px" viewBox="0 0 16 16"
                      class="bi bi-heart-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="swiper-slide"><img src="resources/images/storeimg/6.PNG" width="250px" height="300px">
              <div class="swiper-text" style="padding-left: 0px;">공예
                <div class="text_title">센티멘탈 감성이 짙게 묻은 굿즈</div>
                <div class="like_view"><span class="like_icon"><svg width="8px" height="8px" viewBox="0 0 16 16"
                      class="bi bi-heart-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
