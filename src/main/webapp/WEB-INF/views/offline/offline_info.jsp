...
<body>
	...
	<section class="off_info">
		<div class="main-image">
			<div id="info-img1">
				<img id="img1" src="resources/images/offline/spec/${spec1}">
			</div>
			<div id="info-img2">
				<img id="img2" src="resources/images/offline/spec/${spec2}">
			</div>
			<div id="info-img3">
				<img id="img3" src="resources/images/offline/spec/${spec3}">
			</div>
		</div>
		<div class="info-wrap">
			<div class="all-info">
					<div class="info-l">
						<div class="text-info">
							<img src="/resources/images/offline/content/${offInfo.f_oriname}">
						</div>
								...
								<div class="accordion">
									...
									<div>
										<p>
											...
											부탁드립니다.<br> - 취소 접수를 하지 않은 건에 대해서는 상품이 출고되어 주문 취소가
											불가합니다. 이 경우 부득이하게 반품으로 처리 될 수 있습니다
										</p>
									</div>
						...
						<div
							...
							<div class="like_container">
								<div class="btn_div">
									<button type="button" class="likebtn unfilled_heart"
										...
										<span class="like_num"><span>${offInfo.l_count}</span></span>
									</button>
									<button type="button" class="likebtn full_heart"
							...
							<c:if test="${m_email == ''}">
								<button type="button" class="class_submitbtn" color="red"
									id="apply" fill="true">
									<a onclic="alret();"> <span
										class="sc-fzoyTs jZUSDr" id="apply"><span>클래스
												신청하기</span> </span></a>
								</button>
							</c:if>
							<c:if test="${m_email != ''}">
									...
									<div class="class_submitbtn" color="orange" idid="apply" fill="true">
									<a
										href='/apply?ofc_code=${offInfo.ofc_code}&m_email=${m_email}'>
