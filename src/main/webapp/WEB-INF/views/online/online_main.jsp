		...
		<div class="wrap">
			...
			<span class="cate">
				<div class="cate_container">
					...
					<a class="category tab-link current" data-tab="tab-${tabNum}"
						id="t${tabNum}">전체보기</a>
					<c:forEach var="cate" items="${cateList}">
						<c:set var="tabNum" value="${tabNum + 1}" />
						<a class="category tab-link" data-tab="tab-${tabNum}"
							id="t${tabNum}">${cate.cts_name}</a>
					</c:forEach>
				</div>
			</span>
								...
								<%-- <a class="atag_sum" href="./onlineInfo?onc_code=${on.onc_code}"> --%>
									<div class="swiper-slide">
										<div class="swiper_img">
											<img class="class_img" src="resources/upload/${on.f_sysname}">
										</div>
										...
										<div class="class_likes">${on.l_count}</div>
											...
											<div class="class_bottom">
												<div class="class_startdate">
													<fmt:formatDate value="${on.onc_sdate}"
														pattern="yyyy.MM.dd" />
													부터 수강 가능
												</div>
											</div>
