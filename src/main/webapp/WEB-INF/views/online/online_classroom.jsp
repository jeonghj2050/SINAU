...
<head>
	...
	<link rel="stylesheet" href="resources/css/classroom.css?a">
    <meta charset="UTF-8">
        ...
        <div class="wrap">
            ...
            <div class="ajaxsec">
                ...
                <div class="video_div"><video id="video" class="vieo" src="resources/upload/${selVideoLists.vf_sysname}" 
               		 controls autoplay>동영상 재생 오류 - 관리자에게 문의하세요</video></div>
               	<div class="classProfile"><img class="creatorImg" src="resources/upload/${ClsrCreator.mimg_sysname}" style="width: 50px; height: 50px"> </div>
			...
			<div class="sp_title1">문답 공간 - 피드백</div>
				...
				<div id="reply">
						<div class="replyForm">
							...
							<form role="form" method="post" autocomplete="off" name="fFrm"
								...
								<input type="hidden" class="fb_vf_code" name="fb_vf_code" value='${selVideoLists.vf_code}'>
							<!--	 로그인처리하고 바꾸기 -->
            ...
            <div class="playListSection">
                ...
                <div class="video_lable">
                    <a class="lable" id="${videoLists.vf_code}" href="javascript:void(0);" onclick="classroomFunc(id);">
                   	   ${videoLists.v_title} - ${videoLists.v_content}
                   	</a>
                </div>
                </c:forEach> 
            </div>
